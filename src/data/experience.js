export const experiences = [
  {
    ...
    highlights: [
      ...
      "Managed CI/CD pipelines and collaborated with global engineering teams.",
      "Diagnosed and resolved Jenkins, Kubernetes, and deployment issues.",
    ],
  },
  {
    company: "Netradyne",
    ...
    highlights: [
      ...
      "Worked with developers to validate real-world customer scenarios.",
    ],
  },
];
